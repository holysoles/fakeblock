...
function MakePosts(postsArray) {
  ...
  var postsList = postsArray.map(function (post) {
    ...
    if (post.video.length > 0) {
      console.log('video source length: ', post.video.length); //media = <MakeVideoPlayer source={post.video} />
    }
...
//# sourceMappingURL=posts.js.10278e7834ebfe4cad10.hot-update.js.map