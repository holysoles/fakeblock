...
function pgRedirect() {
  ...
  console.log(router.query.pgRedirect);
  var redirectTo = '';

  for (var i; i < router.query.pgRedirect; i++) {
    redirectTo = redirectTo + '/' + router.query.pgRedirect[i];
  }
...
//# sourceMappingURL=[...pgRedirect].js.34bff0fac7b6398c0f24.hot-update.js.map