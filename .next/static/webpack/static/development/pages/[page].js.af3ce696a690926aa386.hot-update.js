...
function MakeMenu(item) {
  ...
  if (presetIcons.includes(text)) {
    console.log("found icon");
    icon = __jsx(_material_ui_icons_Home__WEBPACK_IMPORTED_MODULE_3___default.a, {
      __self: this,
      __source: {
        fileName: _jsxFileName,
        lineNumber: 19,
  ...
  }, __jsx(_material_ui_core_ListItemIcon__WEBPACK_IMPORTED_MODULE_2__["default"], {
    __self: this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 25,
  ...
  }, icon), __jsx(_material_ui_core_Typography__WEBPACK_IMPORTED_MODULE_4__["default"], {
    variant: "inherit",
    __self: this,
    __source: {
      fileName: _jsxFileName,
...
//# sourceMappingURL=[page].js.af3ce696a690926aa386.hot-update.js.map